...
namespace JView
{
    public partial class TeaPersonInfo : Form
    {
        ...
        {
            label5.Text = tea_info.Instance.t_id + _placeholder;
            label7.Text = tea_info.Instance.t_name + _placeholder;
            label9.Text = ConfigurationManager.AppSettings["Speciality"].Split(',')[stu_info.Instance.major_id + 1] + _placeholder;
            label11.Text = tea_info.Instance.sex + _placeholder;
            label13.Text = tea_info.Instance.grade + _placeholder;
            textBox2.Text = @"●●●●●●";
